...
<div id="coin">
  <div class="side-a ">
    <a href=""><img style="width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%;" src="<?php echo base_url('assets/game2'); ?>/images/tail.png"></a>
    <span class="win"></span>
    <span class="resultwin">You are Fail</span></div>
    <div class="side-a hideMe">
      <img style="width: 100%;height: 100%;border: 22px solid #f00;border-radius: 50%; padding:2px;" src="<?php echo base_url('assets/game2'); ?>/images/coin.gif">
    </div>
</div>
  ...
  <div style="width:100%;display: block;overflow: hidden;">
    <div class="btn-top" style="">
      <p>Select a number please <span>Rate: 1.80</span></p>
    </div>
