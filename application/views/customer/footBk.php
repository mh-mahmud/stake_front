...
<script src="<?php echo base_url(); ?>assets/js/materialView.js"></script>
...
<!-- chat app js -->
<?php //include(APPPATH . "views/chat/app_js.php"); ?> 
</body>
</html>
...
//     var pusher = new Pusher('734a83109a657d6a3c32', {
// 		cluster: 'ap1'
// 	});

// 	var channel_status = pusher.subscribe('chat_status_ch');
// 	channel_status.bind('chat_status_ev', function (data) {
// 		update_chat_status(data);
// 	});

// 	var channel_chat_msg = pusher.subscribe('chat_msg_ch');
// 	channel_chat_msg.bind('chat_msg_ev', function (data) {

// 		var cookie_id = $("#chat_cookie_id").val();
// 		var chat_user_id = $("#chat_user_id").val();

// 		if(data.msg_user_type=='guest') {
// 			if(cookie_id==data.cookie_id) {
// 				get_chat_init_data();
// 			}
// 		}
// 		else if(data.msg_user_type=='user') {
...
<?php if (!empty($this->session->userdata['cus_data']) && is_object($this->session->userdata['cus_data'])) : ?>
    <script type="text/javascript">
        $(document).ready(function() {
        	...
        	setInterval(web_socket_ci,10000);

        	function web_socket_ci() {
        	 	var get_sports_id = $("#sports_id_get").val();
				var get_session_id = $("#current_session").val();

				if (get_session_id=="in_play"){
					live_bets_all_web_socket();
					return;
				}
				if (get_session_id=="in_play_cat"){
					live_bets_by_cat_web_socket(get_sports_id);
					return;
				}
				if (get_session_id=="in_play_single"){
					live_bets_by_single_match_web_socket(get_sports_id);
					return;
				}
				if (get_session_id=="up_play"){
					adv_bets_all_web_socket();
					return;
				}
				if (get_session_id=="up_play_cat"){
					adv_bets_by_cat_web_socket(get_sports_id);
					return;
				}
				if (get_session_id=="up_play_single"){
...
// 			$("#emailDiv").removeClass('active');
// 			$("#phoneId").show();
// 			$("#verified_by").val("phone");
// 			$("#emailId").hide();
// 		});

// 		$("#emailDiv").on('click', function () {
// 			$(this).addClass('active');
// 			$("#phoneDiv").removeClass('active');
// 			$("#phoneId").hide();
// 			$("#verified_by").val("email");
// 			$("#emailId").show();
// 		});
// 	});
// 	// registration step one
// 	$(document).ready(function (e) {
// 		$("#registrationFormOtp").on('submit', (function (e) {
// 			e.preventDefault();
...
// 					swal(
// 						{
// 							title: "Give vailed mobile number",
// 							type: "error",
// 							timer: 2000,
// 							showConfirmButton: true
// 						}
...
// 			var url = url_prefix + 'get_registration_var_code';
// 			$.ajax({
// 				url: url,
// 				type: "POST",
...
// 				processData: false,
// 				beforeSend: function () {
// 					document.getElementById('regBtn').innerText = 'Please Wait...';
// 				},
...
// 							}
// 						);
// 						document.getElementById('regBtn').innerText = 'Get Code';
// 						return;
// 					}
...
// 						document.getElementById('regBtn').innerText = 'Get Code';
// 						$("#registrationFormOtp").fadeOut();
// 						$("#verifyFormOtp").show();
// 						$("#country_v").val(data.country);
// 						$("#phone_v").val(data.phone);
// 						$("#email_v").val(data.email);
// 						$("#verifyNm").html(data.phone + "" + data.email);
// 						$("#verifyOp").html(data.verfiyOp);
// 						$("#verified_op").val(data.verfiyOp);
// 						return;
// 					}
...
// 	$(document).ready(function (e) {
// 		$("#verifyFormOtp").on('submit', (function (e) {
// 			e.preventDefault();
...
// 			var url_prefix = "<?php// echo base_url(); ?>";
// 			var url = url_prefix + 'betscore/verifyOtpCode';
// 			$.ajax({
// 				url: url,
// 				type: "POST",
// 				data: new FormData(this),
...
// 				processData: false,
// 				beforeSend: function () {
// 					document.getElementById('verifyBtn').innerText = 'Please Wait...';
// 				},
...
// 							}
// 						);
// 						document.getElementById('verifyBtn').innerText = 'Verify Code';
// 						return;
// 					}
...
// 						document.getElementById('verifyBtn').innerText = 'Verify Code';
// 						$("#verifyFormOtp").fadeOut();
// 						$("#personalInfoFormOtp").show();
// 						$("#country_o").val(data.country);
// 						$("#phone_o").val(data.phone);
// 						$("#email_o").val(data.email);
// 						$("#otp_o").val(data.otp_code);
// 						$("#verified_o").val(data.verified_by);
// 						return;
// 					}
...
<script> 
    ...
    function youtube_link(link) {
    	...
    	$("#liveTvSrc").html("<div class='betslip-bid-area'>"+
				"<iframe width='100%' height='250' src='"+link+"'></iframe>"+
			"</div>");
    }
